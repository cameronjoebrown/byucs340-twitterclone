...
/**
 * A DAO for accessing and manipulating data in the follows table
 */
public class FollowDAO {
    ...
    public FollowerResponse getFollowers(FollowerRequest request) {
        ...
        while (iterator.hasNext()) {
            ...
            User follower = userDAO.viewUser(viewUserRequest).getUser();
    ...
    public FollowingResponse getFollowees(FollowingRequest request) {
        ...
        while (iterator.hasNext()) {
            ...
            User followee = userDAO.viewUser(viewUserRequest).getUser();
