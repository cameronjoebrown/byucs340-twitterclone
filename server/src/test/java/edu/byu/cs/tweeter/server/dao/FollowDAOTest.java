...
class FollowDAOTest {
    ...
    void testGetFollowees_noFolloweesForUser() {
        ...
        FollowingRequest request = new FollowingRequest(user1.getUsername(), 10, null);
    ...
    void testGetFollowees_twoFollowersForUser_limitEqualsUsers() {
        ...
        FollowingRequest request = new FollowingRequest(user3.getUsername(), 2, null);
        FollowingResponse response = followingDAOSpy.getFollowees(request);
    ...
    void testGetFollowees_limitLessThanUsers_endsOnPageBoundary() {
        ...
        FollowingRequest request = new FollowingRequest(user5.getUsername(), 2, null);
        FollowingResponse response = followingDAOSpy.getFollowees(request);
        ...
        request = new FollowingRequest(user5.getUsername(), 2, response.getFollowees().get(1).getUsername());
    ...
    void testGetFollowees_limitLessThanUsers_notEndsOnPageBoundary() {
        ...
        FollowingRequest request = new FollowingRequest(user6.getUsername(), 2, null);
        FollowingResponse response = followingDAOSpy.getFollowees(request);
        ...
        // Get and verify second page
        request = new FollowingRequest(user6.getUsername(), 2, response.getFollowees().get(1).getUsername());
        response = followingDAOSpy.getFollowees(request);
