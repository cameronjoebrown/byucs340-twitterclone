...
public class FollowServiceTest {
    ...
    /**
     * Verify that for successful requests the {@link FollowService#follow(FollowUnfollowRequest)}
     * method returns the same result as the {@link ServerFacade}.
     * .
     */
    @Test
    public void testUnfollow_validRequest_correctResponse() {
        Response response = followServiceSpy.follow(validRequest);
        Assertions.assertEquals(successResponse, response);
    }

    /**
     * Verify that for invalid requests the {@link FollowService#follow(FollowUnfollowRequest)}
     * method returns the same result as the {@link ServerFacade}.
     *
     */
    @Test
    public void testUnfollow_invalidRequest() {
        Response response = followServiceSpy.follow(invalidRequest);
